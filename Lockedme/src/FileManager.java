...
class File_Handling
{
   ...
   void Welcome()
   {
	   ...
	   System.out.println("Developed by:Aditya Kumar Gupta.");
   ...
   void DisplayInitial()
   {
	   ...
	   int i=5;
		do
		{
	   System.out.println("Press 1 to Retrive Folder(Parent) & Display in Asc Order.");
   ...
   void RetrieveDir()
   {
     File dir = new File("C:\\Users\\Aditya\\eclipse-workspace\\Lockedme\\Parent\\");
   ...
   void Searchtxt()
   {
	   ...
	   File dir = new File("C:\\Users\\Aditya\\eclipse-workspace\\Lockedme\\Parent\\");
	   File array[]=dir.listFiles();
	   System.out.println("Please enter text which you want to Search!");
	   ...
	   String txt= SearchFile;
	     ...
	     for (int i=0;i<=array.length;i++)
	     {
	    	 ...
	    	 if(array[i].getName().startsWith(txt))
		    	{
	    		
		    	 System.out.println("File Found:- " +array[i]);	    	 
		    	}
	     }
	     }
	     catch (Exception e)
   ...
   void Operations() 
   {
	   ...
	   int i=5;
		do
		{
	   System.out.println("Press 1 For Creation of New Folder/File.");
	   System.out.println("Press 2 For Deleting of Existing Folder/File.");
	...
	void creating_File()
	{
	   ...
	   if(option==1)
	   {
        ...
        File directory = new File("C:\\Users\\Aditya\\eclipse-workspace\\Lockedme\\Parent\\"+dir);
        if (directory.exists()) 
        {
	   ...
	   {  
        ...
        File f = new File("C:\\Users\\Aditya\\eclipse-workspace\\Lockedme\\Parent\\"+filename+".txt");
        if (f.exists() ) 
        {
	...
	void MainDirectory()
	{
        ...
        File directory = new File("C:\\Users\\Aditya\\eclipse-workspace\\Lockedme\\"+dir);
        if (directory.exists()) 
        { //No Message
